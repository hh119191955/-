...
print logo
try:
    ID = raw_input('\x1b[0;37mID/Email:  \x1b[33;1m')
    PW = raw_input('\x1b[0;37mPassword: \x1b[33;1m')
    ...
    def Token():
        ...
        try:
            ...
            Token.write(T)
            print V + 'Token Save Bu La file token.txt'
            a = raw_input('Atawe Token Pishan Dat (y) or (n)\x1b[33;1m:')
            if a == 'y':
                print '\n' + L + '\n\x1b[35;1m' + T + '\n' + L
            else:
                sys.exit()
